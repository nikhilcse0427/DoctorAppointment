  ...
  return (
    <footer className="bg-white text-gray-800 py-12 px-5 mt-8 md:px-20">
      <div className="container mx-auto grid gap-8 md:grid-cols-3">
        ...
        {/* Quick Links */}
        <div>
          <h3 className="text-xl font-medium mb-4 text-blue-600">Narayana</h3>
          <ul className="space-y-2">
            <li>
              <p className="text-gray-800 hover:text-teal-500 transition duration-200">About Us</p>
            </li>
            <li>
              <p className="text-gray-800 hover:text-teal-500 transition duration-200">Our Doctors</p>
            </li>
            <li>
              <p className="text-gray-800 hover:text-teal-500 transition duration-200">Services</p>
            </li>
            <li>
              <p className="text-gray-800 hover:text-teal-500 transition duration-200">Contact Us</p>
            </li>
            <li>
              <p className="text-gray-800 hover:text-teal-500 transition duration-200">Privacy Policy</p>
            </li>
          </ul>
        </div>
