...
const Banner = () => {
  ...
  return (
    <div className=" mt-8 flex flex-col items-center justify-center h-[400px] bg-gray-100  text-center p-8 md:p-12 rounded-xl shadow-xl">
      ...
      <button onClick={()=>{navigate('/register');scrollTo(0,0)}}className="bg-blue-400 text-white px-8 py-3 rounded-full font-medium text-lg shadow-lg hover:bg-blue-800 hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
        Create Account
      </button>
    </div>
  );
