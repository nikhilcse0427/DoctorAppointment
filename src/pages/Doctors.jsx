      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        <div className="cursor-pointer w-full sm:w-1/4 lg:w-1/5 flex flex-col gap-4 p-4 bg-slate-100 shadow-md rounded-lg">
          ...
          <p
            ...
            className={`bg-white w-full pl-2 p-1 border border-gray-300 rounded-sm ${selectedSpeciality === 'Pediatricians' ? 'bg-yellow-400 text-black' : ''}`}
          >
            Pediatricians
          </p>
          <p
          ...
          <p
            ...
            className={`bg-white w-full pl-2 p-1 border border-gray-300 rounded-sm ${selectedSpeciality === 'Gastroenterologist' ? 'bg-yellow-400 text-black' : ''}`}
          >
            Gastroenterologist
          </p>
        </div>
